    ...
    try:
        ...
        if len(pdgms) > 0:
            ...
            if generate_persistence_image:
                ...
                plt.tight_layout()
                plt.savefig(f'{base_path}/{variable_name}_{county_code}_peristence_diagram.png')
                plt.close()


                # plotting the persistence image
                fig, ax = plt.subplots(figsize=(10, 10))
                ...
                plt.tight_layout()
                plt.savefig(f'{base_path}/{variable_name}_{county_code}_peristence_image.png')
                plt.close()
